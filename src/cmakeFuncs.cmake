...
#
# Workaround to support target_sources() for cmake <3.12
#	https://crascit.com
...
message("###-A: target: " ${target})

	# If here, must be using CMake 3.12 or earlier, so simulate the new behavior
	unset(_srcList)
...
#message("###-A: in if")
				...
				# prepend relative to where target was defined
				file(
					RELATIVE_PATH src
					"${_targetSourceDir}"
